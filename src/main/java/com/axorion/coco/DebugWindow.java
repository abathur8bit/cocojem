/*
 * Created by JFormDesigner on Tue Mar 05 06:23:55 EST 2019
 */
...
public class DebugWindow extends JDialog {
    public DebugWindow(Frame owner) {
        super(owner);
        initComponents();
    }

    public DebugWindow(Dialog owner) {
        super(owner);
        initComponents();
        source.setText("XXX");
        source.append("YYY");
        source.setCaretPosition(20);
    }
    ...
    private void initComponents() {
        ...
        contentPane.add(registersPanel, BorderLayout.EAST);

        //======== scrollPane1 ========
        {

            //---- source ----
            source.setFont(new Font("Monospaced", source.getFont().getStyle(), source.getFont().getSize()));
